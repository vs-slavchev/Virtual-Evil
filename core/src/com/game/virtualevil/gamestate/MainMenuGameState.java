...
public class MainMenuGameState extends GameState {
    ...
    public void initialize() {
        ...
        blackTrapezoid = new TextureRegion(assetManager.getTextureManager()
                .getImage("startScreenBackground"),
                0, 68, 86, 30);
        ...
        TextureRegion chipsTileset = assetManager.getTextureManager().getImage("chipBuildings");
    ...
    /* Hard code the values of the digits animation. No need to load them at startup. */
